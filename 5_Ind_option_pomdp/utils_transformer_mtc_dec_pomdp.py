"""
    Copied MARL_Transformer_Actor_Critic/13_MTC_SAC_DecPOMDP
"""
import numpy as np


def make_po_attention_mask(alive_agents_ids, max_num_agents, agents, com):
    """ attention mask (=adjacency matrix): (1,n,n), bool """
...
def make_padded_pos(max_num_agents, pos_shape, raw_pos):
