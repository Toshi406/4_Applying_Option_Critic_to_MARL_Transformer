"""
Copied from Applying_Option_Critic_to_MARL_Transformer/4_Individual_option/global_models_team_option.py
"""
import os
import numpy as np
...
def main():
    ...
    """ check conv_network """
    states = np.random.rand(config.batch_size, config.global_grid_size, config.global_grid_size,
