"""
Copied from Applying_Option_Critic_to_MARL_Transformer/5_Ind_option_pomdp/config_separate_supervisor.py
"""
import numpy as np
import gym
...
class Config:
    def __init__(self):
        ...
        self.supervisor_dir = 'models/supervisor_1090000/'  # newest file -> 'ls -ltr'
        self.po_agents_dir = 'models/po_agents_1090000/'
        # self.supervisor_dir = None
        # self.po_agents_dir = None

        if self.supervisor_dir:  # starting steps for continual training
            self.n0 = 1090000  # learner update cycles. Should be read from tensorboard
        else:
            self.n0 = 0
        ...
        self.blue_platoons = (41, 50)  # num range of blue platoons, default=(3,10)
