...
class Config:
    def __init__(self):
        ...
        self.model_dir = 'models/oc_model_670000/'  # newest file -> 'ls -ltr'
        # self.model_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 670000  # learner update cycles. Should be read from tensorboard
        else:
            self.n0 = 0
        ...
        self.max_episodes_test_play = 200  # default=50 for training
        ...
        self.red_platoons = (41, 50)  # num range of red platoons, default=(3,10)
