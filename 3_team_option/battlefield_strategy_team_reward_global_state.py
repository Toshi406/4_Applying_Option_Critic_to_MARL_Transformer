"""
Copied from 'MARL_Transformer_Actor_Critic/10_SAC_GlobalState_1/1_Pre_Training'
"""
import gym
import numpy as np
...
from observations_global_state import get_observations, get_global_observation
...
""" Modified form 'battlefield_strategy_rev10_finetuning' """
...
class BattleFieldStrategy(gym.Env):
    ...
    def reset(self):
        ...
        global_observation = get_global_observation(self)  # Get initial globa; observation
