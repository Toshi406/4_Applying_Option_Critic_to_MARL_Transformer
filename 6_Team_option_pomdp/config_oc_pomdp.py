"""
Copied from Applying_Option_Critic_to_MARL_Transformer/5_Ind_option_pomdp/config_oc_pomdp.py
"""
import numpy as np
import gym
...
class Config:
    def __init__(self):
        ...
        self.model_dir = 'models/oc_model_1430000/'  # newest file -> 'ls -ltr'
        # self.model_dir = None

        if self.model_dir:  # starting steps for continual training
            self.n0 = 1430000  # learner update cycles. Should be read from tensorboard
        else:
            self.n0 = 0
        ...
        self.grid_size = 100  # default=15
        self.offset = 0  # blue-team offset from edges

        # When agents are tested in larger battlefield, the global_grid_size will
        # be applied to the supervisor.  This mechanism is built in.
        ...
        self.gamma = 0.96
        self.max_steps = 400  # Default=100. 200 for robustness
        ...
        self.red_platoons = (300, 300)  # num range of red platoons, default=(3,10)
        self.red_companies = (300, 300)  # num range of red companies, default=(2,5)

        self.blue_platoons = (700, 700)  # num range of blue platoons, default=(3,10)
        self.blue_companies = (700, 700)  # num range of blue companies, default=(2,5)
