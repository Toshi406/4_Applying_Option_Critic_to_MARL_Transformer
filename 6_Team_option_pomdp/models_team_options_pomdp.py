"""
Copied from 5_Ind_option_pomdp, then modified.
    Use "TerminationHead" in "global_models_team_option.py",
        instead of "AgentTerminationHead" in "sub_models_indiv_option_pomdp.py"
"""
import numpy as np
...
from sub_models_indiv_option_pomdp import CNNModel, MultiHeadAttentionModel, AgentPolicyHead, \
    AgentQHead
from global_models_team_option import GlobalCNNModel, TerminationHead
...
class Team_OptionCritic_Model(tf.keras.models.Model):
    """
    Model: "team__option_critic__model"
    _________________________________________________________________
     Layer (type)                Output Shape              Param #
    =================================================================
    ...
    =================================================================
    Total params: 548,796
    Trainable params: 548,796
    Non-trainable params: 0
    _________________________________________________________________
    """

    def __init__(self, config, **kwargs):
        super(Team_OptionCritic_Model, self).__init__(**kwargs)
    ...
    def call(self, inputs, mask, attention_mask):
        ...
        termination_probs = \
            self.termination_head(global_feature)
        # (b,option_dim)
...
def main():
    ...
    termination_bools = \
        oc_model.termination_head.sample_termination(termination_probs, options)
